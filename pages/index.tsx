...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="relative background flex flex-col items-center w-screen px-8 h-screen pt-12">
        <Header score={score} />
        {results ? (
          <Results
            results={results}
        ...
        <button
          ...
          className="absolute md:right-10  bottom-10 w-32 py-3 bg-transparent border-solid text-white hover:bg-white hover:text-scoreText border-2 rounded-lg"
        >
          RULES
        </button>
      </main>
